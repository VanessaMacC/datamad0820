...
list_square = [x**2 for x in range(20)]
print (list_square)
...
list_square2 = [math.sqrt(x) for x in range(100)]
print(list_square2)
...
non_vowels = ["-".join([x for x in teststring if x not in 'aeiou'])]
print (non_vowels)
...
sep = '\n'
consonants = sep.join([x for x in sentence2 if x not in 'aeiou'])
print(consonants)
...
files = [x for x in os.listdir('/Users/Vanesuki/repos/datamad0820')]
print(files)
